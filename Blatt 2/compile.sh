...
exec javac -cp $CLASSPATH MiniPython*.java *AST*.java Scope.java BuiltinIdsScope.java ClassScope.java ScopeListener.java Symbol.java Type.java MiniPythonInterpreter.java
