...
public class MiniPythonLexer extends Lexer {
	...
	private static String[] makeRuleNames() {
		return new String[] {
			...
			"T__17", "END", "COMMENT", "WS", "ID", "INTLITERAL", "Stringcontent", 
			"STRINGLITERAL", "BOOLEANLITERAL", "MATHMULDIV", "MATHADDSUB", "DIVISION", 
			"MULTIPLICATION", "ADDITION", "SUBTRACTION", "ASSERTOPERATOR", "ASSERTEQUAL", 
			"ASSERTNOTEQUAL", "ASSERTLESS", "ASSERTMORE", "ASSERTLESSEQUAL", "ASSERTMOREEQUAL"
		};
	}
